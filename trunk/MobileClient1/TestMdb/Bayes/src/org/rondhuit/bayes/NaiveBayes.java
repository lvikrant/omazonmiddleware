...
public class NaiveBayes implements Classifier {
        ...
        {
            StringAttribute aAttr = new StringAttribute();
            Concept concept = new BaseConcept("Apple");
            Instance instance = new BaseInstance(concept, aAttr);
            TrainingSet tSet = new TrainingSet();
            NaiveBayes naive = new NaiveBayes("NaiveBayes", tSet);
        }
}